...
export function Footer() {
  ...
  return (
    // Forzamos el tema oscuro solo para el footer
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-10 text-center md:text-left">
          ...
          <div className="flex flex-col gap-2 md:w-1/3">
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              <a
                href="https://github.com" // TODO: Poner tu enlace de GitHub
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://linkedin.com" // TODO: Poner tu enlace de LinkedIn
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
              ...
              <a
                href="https" // TODO: Poner tu enlace web
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors"
